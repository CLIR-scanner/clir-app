...
const styles = StyleSheet.create({
  ...
  saveBtnText: { fontSize: 13, fontFamily: 'Pretendard-SemiBold', color: DARK_GREEN },
  ...
  profileName: { fontSize: 20, fontFamily: 'Pretendard-Bold', color: DARK_GREEN, textAlign: 'center' },
  nameInput:   {
    fontSize: 20, fontFamily: 'Pretendard-Bold', color: DARK_GREEN, textAlign: 'center',
  ...
  addToggleBtnText: { fontSize: 14, fontFamily: 'Pretendard-Bold', color: DARK_GREEN },
});
