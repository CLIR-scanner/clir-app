...
const s = StyleSheet.create({
  ...
  title: { fontSize: 22, fontFamily: 'Pretendard-Bold', color: DARK_GREEN, lineHeight: 30, marginBottom: 10 },
  ...
  btnText: { fontSize: 15, fontFamily: 'Pretendard-Bold', color: '#FFFFFF' },
  options: { gap: 12 },
  option: {
  ...
  optionLabel: { fontSize: 15, fontFamily: 'Pretendard-SemiBold', color: DARK_GREEN },
  ...
  addBtnText: { fontSize: 15, fontFamily: 'Pretendard-SemiBold', color: DARK_GREEN },
  editBtn: {
  ...
  editBtnText: { fontSize: 15, fontFamily: 'Pretendard-Bold', color: DARK_GREEN },
  modalOverlay: {
  ...
  modalTitle: { fontSize: 18, fontFamily: 'Pretendard-Bold', color: DARK_GREEN, marginBottom: 6 },
  ...
  modalItemText: { fontSize: 14, color: DARK_GREEN, fontFamily: 'Pretendard-Regular' },
  ...
  modalSaveBtnText: { fontSize: 15, fontFamily: 'Pretendard-Bold', color: '#FFFFFF' },
  checkbox: {
