...
export default function EmailCodeScreen() {
  ...
  function handleContinue() {
    ...
    if (entered.length < CODE_LENGTH) {
      Alert.alert('인증 코드 6자리를 모두 입력해주세요.');
      return;
    }
    // 더미: 아무 코드나 통과
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.body}>
        <Text style={styles.title}>Check your email{'\n'}for a code</Text>
      ...
      <View style={styles.footer}>
        <View style={styles.resendRow}>
          ...
          <Text style={styles.resendText}>  in  {timerLabel}</Text>
        </View>
        <TouchableOpacity onPress={() => navigation.goBack()}>
          <Text style={styles.tryAnother}>
            Go back to <Text style={styles.tryAnotherLink}>Try another email</Text>
          </Text>
        </TouchableOpacity>
