...
const styles = StyleSheet.create({
  ...
  modalTitles:      { flex: 1 },
  modalName:        { fontSize: 20, fontFamily: 'Pretendard-ExtraBold', color: '#1A1A1A' },  modalCloseBtn:    { width: 28, height: 28, borderRadius: 14, backgroundColor: '#F0F0F0', alignItems: 'center', justifyContent: 'center', marginLeft: 12 },
