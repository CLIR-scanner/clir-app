...
export type AuthStackParamList = {
  ...
  TermsAgreement: { agreedSection?: TermsSectionKey; pendingProvider?: 'google' | 'apple' | 'guest' } | undefined;
  /** 약관 항목별 원문 상세 — TermsAgreement 에서 chevron 클릭 시 진입 */
  TermsDetail: { section: TermsSectionKey; agreed?: boolean };
  /** pendingProvider 가 있으면 약관 동의 직후 해당 provider 로그인 자동 진행 ('guest' = 익명 진입) */
  AuthHome: { pendingProvider?: 'google' | 'apple' | 'guest' } | undefined;
