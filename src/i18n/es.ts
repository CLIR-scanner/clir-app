const es = {
  ...
  auth: {
    ...
    termsAgreement: {
      ...
      agreeAll:                     'Acepto todo.',
      agreeAllDescription:          'Aceptar todo incluye el consentimiento a los elementos obligatorios y opcionales. Puedes usar el servicio aunque rechaces los opcionales.',
      termsService:                 'Términos de servicio',
      privacyPolicy:                'Política de privacidad',
      personalInformation:          'Recopilación y uso de información personal',
      healthDisclaimer:             'Aviso de salud',
      healthDisclaimerDescription:  'El análisis de la app es solo orientativo. Comprueba siempre la etiqueta del producto antes de consumirlo.',
      ageConfirm:                   'Tengo 13 años o más',
      marketing:                    'Comunicaciones de marketing',
      dataAnalytics:                'Consentimiento de análisis de datos',
  ...
  multiProfileDetail: {
    ...
    currentlyActive: 'Activo actualmente', scanEnabled: 'Active', scanDisabled: 'Inactive', sectionSensitivity: 'Sensibilidad', modeLabel: 'Modo',
  ...
  qaUi: {
    ...
    noMatchingQuestions:  'No hay preguntas que coincidan.',
    noQuestions:          'Aún no hay preguntas.',
    noticeTitle:          'Bienvenido a la comunidad Clir',
    ...
    editPostCaption:      'No se pueden cambiar la categoría ni las imágenes adjuntas.',
    fieldTitle:           'Título',
    ...
    block:                'Bloquear',
    manageAnswer:         'Gestionar respuesta',
    reportAnswer:         'Reportar respuesta',
    managePost:           'Gestionar publicación',
    reportPost:           'Reportar publicación',
    alertTitle:           'Aviso',
    reportReasonPrompt:   'Describe brevemente el motivo. Lo revisamos en 24 horas.',
    reportReasonRequired: 'Ingresa un motivo para reportar.',
    reportSubmitted:      'Tu reporte fue recibido. Lo revisamos en 24 horas.',
    alreadyReported:      'Ya has reportado esto.',
    reportFailed:         'No se pudo enviar el reporte.',
    blockUserMessage:     'Ya no verás las publicaciones ni respuestas de este usuario.',
    userBlocked:          'Usuario bloqueado.',
    blockFailed:          'No se pudo bloquear al usuario.',
    deletePostTitle:      'Eliminar publicación',
    deletePostMessage:    'Al eliminar también se borran las respuestas y no se puede deshacer.',
    deleteAnswerTitle:    'Eliminar respuesta',
    deleteAnswerMessage:  'Una respuesta eliminada no se puede restaurar.',
    titleBodyRequired:    'Ingresa un título y contenido.',
    titleBodyLimit:       'Título hasta 100 y contenido hasta 2000 caracteres.',
    answerLimit:          'Las respuestas pueden tener hasta 1000 caracteres.',
    postLoadFailed:       'No se pudo cargar la publicación.',
    answerSubmitFailed:   'No se pudo publicar tu respuesta.',
    postAlreadyDeleted:   'La publicación ya fue eliminada.',
    editFailed:           'No se pudo editar.',
    answerAlreadyDeleted: 'La respuesta ya fue eliminada.',
    answerEditFailed:     'No se pudo editar la respuesta.',
    deleteFailed:         'No se pudo eliminar.',
    answerDeleteFailed:   'No se pudo eliminar la respuesta.',
    errCreateFailed:      'No se pudo publicar.',
    errImageTooLarge:     'Las imágenes deben pesar 5MB o menos.',
    errInvalidFileType:   'Solo se pueden subir imágenes jpg/png/webp.',
    errProductNotFound:   'No se encontró el producto. Selecciónalo de nuevo.',
    errInvalidInputCreate:'Revisa el título, el contenido y la categoría.',
    errTooManyRequests:   'Demasiadas solicitudes. Inténtalo más tarde.',
    errServiceUnavailable:'El servicio no está disponible temporalmente. Inténtalo más tarde.',
    errNetwork:           'No se puede conectar a la red.',
    errTimeout:           'La solicitud expiró. Inténtalo de nuevo.',
    errForbidden:         'Solo puedes editar o eliminar tus propias publicaciones.',
    errPostNotFound:      'La publicación ya fue eliminada o no existe.',
    errAnswerNotFound:    'La respuesta ya fue eliminada o no existe.',
    errInvalidInput:      'La solicitud no es válida.',
  },
  survey: {
