const ko = {
  ...
  sensitivity: {
    title:       '민감도 설정',
    subtitle:    '알레르기 프로필에 따라 앱이 성분을 얼마나 엄격하게 필터링할지\n선택하세요.',
    strictLabel: '엄격 모드',
  ...
  product: {
    ...
    severeDisclaimer:    '** 중증 알레르기가 있는 경우, 섭취 전 모든 성분을 다시 확인\n해주세요.',
  },
  ...
  profileUi: {
    ...
    vegetarianOptionSubtitle:'채식 유형을 선택하세요.식이 규칙에 맞춰 식품을 필터링하는 데 \n사용됩니다.',
  ...
  qaUi: {
    ...
    noMatchingQuestions:  '검색 결과가 없습니다.',
    noQuestions:          '아직 질문이 없습니다.',
    noticeTitle:          '클리어 커뮤니티에 오신 것을 환영합니다',
    askTitle:             '질문하기',
    submit:               '등록',
    ...
    notice:               '공지',
    answers:              '답변',
    noAnswers:            '아직 답변이 없습니다. 첫 답변을 남겨보세요.',
    send:                 '전송',
    editPost:             '게시글 수정',
    editPostCaption:      '카테고리·첨부 이미지는 변경할 수 없습니다.',
    fieldTitle:           '제목',
    fieldContent:         '내용',
    edit:                 '수정',
    report:               '신고',
    ...
    reportPost:           '게시글 신고',
    alertTitle:           '알림',
    reportReasonPrompt:   '신고 사유를 간단히 입력해 주세요. 24시간 내 검토됩니다.',
    reportReasonRequired: '신고 사유를 입력해 주세요.',
    reportSubmitted:      '신고가 접수되었습니다. 24시간 내 검토됩니다.',
    alreadyReported:      '이미 신고하신 항목입니다.',
    reportFailed:         '신고를 접수하지 못했습니다.',
    blockUserMessage:     '이 사용자의 게시글과 답변이 더 이상 보이지 않습니다.',
    userBlocked:          '사용자를 차단했습니다.',
    blockFailed:          '차단에 실패했습니다.',
    deletePostTitle:      '게시글 삭제',
    deletePostMessage:    '삭제하면 답변도 함께 삭제되며 되돌릴 수 없습니다.',
    deleteAnswerTitle:    '답변 삭제',
    deleteAnswerMessage:  '삭제한 답변은 되돌릴 수 없습니다.',
    titleBodyRequired:    '제목과 내용을 모두 입력해 주세요.',
    titleBodyLimit:       '제목은 100자, 내용은 2000자까지 입력할 수 있습니다.',
    answerLimit:          '답변은 1000자까지 입력할 수 있습니다.',
    postLoadFailed:       '게시글을 불러올 수 없습니다.',
    answerSubmitFailed:   '답변을 등록할 수 없습니다.',
    postAlreadyDeleted:   '게시글이 이미 삭제되었습니다.',
    editFailed:           '수정에 실패했습니다.',
    answerAlreadyDeleted: '답변이 이미 삭제되었습니다.',
    answerEditFailed:     '답변 수정에 실패했습니다.',
    deleteFailed:         '삭제에 실패했습니다.',
    answerDeleteFailed:   '답변 삭제에 실패했습니다.',
    errCreateFailed:      '글 등록에 실패했습니다.',
    errImageTooLarge:     '이미지는 5MB 이하만 업로드 가능합니다.',
    errInvalidFileType:   'jpg/png/webp 이미지만 업로드할 수 있습니다.',
    errProductNotFound:   '선택한 제품 정보를 찾을 수 없습니다. 제품을 다시 선택해 주세요.',
    errInvalidInputCreate:'제목·내용·카테고리를 확인해 주세요.',
    errTooManyRequests:   '요청이 너무 많습니다. 잠시 후 다시 시도해 주세요.',
    errServiceUnavailable:'서비스를 일시적으로 사용할 수 없습니다. 잠시 후 다시 시도해 주세요.',
    errNetwork:           '네트워크에 연결할 수 없습니다.',
    errTimeout:           '요청 시간이 초과되었습니다. 다시 시도해 주세요.',
    errForbidden:         '본인이 작성한 글만 수정·삭제할 수 있습니다.',
    errPostNotFound:      '게시글이 이미 삭제되었거나 존재하지 않습니다.',
    errAnswerNotFound:    '답변이 이미 삭제되었거나 존재하지 않습니다.',
    errInvalidInput:      '요청 내용이 올바르지 않습니다.',
  },
  ...
  survey: {
    ...
    foundTitle:         '찾아낸 성분은 다음과 같아요.',
    selectedTitle:      '선택한 성분은 다음과 같아요.',
    ...
    dietKindTitle:      '어떤 식단을 따르나요?',
    dietKindSubtitle:   '식습관에 가장 잘 맞는 옵션을 선택하세요.',
    veganStrictTitle:   '비건 식단의 엄격도는?',
    ...
    dietConfirmSubtitle:'선택한 식이 선호가 필터링 옵션에 적용됩니다.',
    vegetarianAvoidTitle:'{{diet}} 기준으로\n피하는 성분',
    vegetarianAvoidSubtitle:'선택한 식단을 기준으로 해당 성분들이 필터링됩니다.',
